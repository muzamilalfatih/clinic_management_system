...
namespace clinic_management_system_API.Controllers
{
    ...
    public class ReceptionistsController : ControllerBase
    {
        ...
        public async Task<ActionResult<ReceptionistDTO>> UpdateReceptionist([FromBody] UpdateReceptionistRequestDTO updateReceptionistRequestDTO)
        {
            ...
            UpdateReceptionistDTO updateReceptionistDTO = new UpdateReceptionistDTO((int)currentUserId, updateReceptionistRequestDTO);

            Result<bool> result = await _service.UpdateReceptionist(updateReceptionistDTO);
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<ReceptionistDTO>> UpdateReceptionist(int id, [FromBody] UpdateReceptionistRequestDTO updateReceptionistRequestDTO)
        {

            UpdateReceptionistDTO updateReceptionistDTO = new UpdateReceptionistDTO(id, updateReceptionistRequestDTO);
