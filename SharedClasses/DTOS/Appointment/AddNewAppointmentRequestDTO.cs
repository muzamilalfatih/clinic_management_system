...
{
    public class AddNewAppointmentRequestDTO
    {
        public AddNewAppointmentRequestDTO(int patientId, int doctorId, DateTime date, string? notes, int? parentAppointmentId)
        {
            PatientId = patientId;
            DoctorId = doctorId;
            Date = date;
